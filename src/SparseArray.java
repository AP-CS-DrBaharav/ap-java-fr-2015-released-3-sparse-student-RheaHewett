...
public class SparseArray
{
  ...
  public static void main(String[] args)
  {
    ...
    System.out.println("sparse.getValueAt(3, 1) = (should be -9) " + sparse.getValueAt(3, 1));
    System.out.println("sparse.getValueAt(3, 1) = (should be 0) " + sparse.getValueAt(3, 3));

    System.out.println("BEFORE removing column 1, printing array");
    System.out.println(sparse);
    sparse.removeColumn(1);    
    System.out.println("AFTER removing column 1, printing array");
    System.out.println(sparse);
  }  
}
